// Command BluefinShieldconexMgmt-mcp is an MCP server exposing the BluefinShieldconexMgmt
// SDK as MCP tools.
//
// Two tools are registered:
//
//	BluefinShieldconexMgmt_list  — list records of an entity
//	BluefinShieldconexMgmt_load  — load a single record of an entity
//
