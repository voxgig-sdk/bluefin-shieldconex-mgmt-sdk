...
type Args struct {
	Entity string         `json:"entity" jsonschema:"client | clone | partner | template | transaction | update_result | user"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.BluefinShieldconexMgmtSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "bluefin-shieldconex-mgmt_list",
		Description: "List records from BluefinShieldconexMgmt. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "bluefin-shieldconex-mgmt_load",
		Description: "Load a single record from BluefinShieldconexMgmt. " +
...
func runOp(client *sdk.BluefinShieldconexMgmtSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.BluefinShieldconexMgmtSDK, name string) (sdk.BluefinShieldconexMgmtEntity, error) {
