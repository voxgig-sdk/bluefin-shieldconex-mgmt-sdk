...
local PartnerEntity = {}
PartnerEntity.__index = PartnerEntity


function PartnerEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PartnerEntity)
  self._name = "partner"
  self._client = client
...
function PartnerEntity:get_name()
  return self._name
end


function PartnerEntity:make()
  local opts = {}
...
function PartnerEntity:data_set(args)
  if args ~= nil then
...
function PartnerEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PartnerEntity:match_set(args)
  if args ~= nil then
...
function PartnerEntity:match_get()
...
function PartnerEntity:stream(action, args, callopts)
...
---@param reqmatch PartnerLoadMatch
---@param ctrl? table
---@return Partner
---@return string? err
function PartnerEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch PartnerListMatch
---@param ctrl? table
---@return Partner[]
---@return string? err
function PartnerEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata PartnerCreateData
---@param ctrl? table
---@return Partner
---@return string? err
function PartnerEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
function PartnerEntity:_run_op(ctx, post_done)
  local utility = self._utility
