...
function ClientEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ClientEntity)
  self._name = "client"
  self._client = client
...
function ClientEntity:get_name()
  return self._name
end


function ClientEntity:make()
  local opts = {}
...
function ClientEntity:data_set(args)
  if args ~= nil then
...
function ClientEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ClientEntity:match_set(args)
  if args ~= nil then
...
function ClientEntity:match_get()
...
function ClientEntity:stream(action, args, callopts)
...
---@param reqmatch ClientLoadMatch
---@param ctrl? table
---@return Client
---@return string? err
function ClientEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ClientListMatch
---@param ctrl? table
---@return Client[]
---@return string? err
function ClientEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ClientCreateData
---@param ctrl? table
---@return Client
---@return string? err
function ClientEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqmatch ClientRemoveMatch
---@param ctrl? table
---@return Client
---@return string? err
function ClientEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function ClientEntity:_run_op(ctx, post_done)
  local utility = self._utility
