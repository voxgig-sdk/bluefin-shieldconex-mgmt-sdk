...
TemplateEntity.__index = TemplateEntity


function TemplateEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TemplateEntity)
  self._name = "template"
  self._client = client
...
function TemplateEntity:get_name()
  return self._name
end


function TemplateEntity:make()
  local opts = {}
...
function TemplateEntity:data_set(args)
  if args ~= nil then
...
function TemplateEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TemplateEntity:match_set(args)
  if args ~= nil then
...
function TemplateEntity:match_get()
...
function TemplateEntity:stream(action, args, callopts)
...
---@param reqmatch TemplateLoadMatch
---@param ctrl? table
---@return Template
---@return string? err
function TemplateEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch TemplateListMatch
---@param ctrl? table
---@return Template[]
---@return string? err
function TemplateEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata TemplateCreateData
---@param ctrl? table
---@return Template
---@return string? err
function TemplateEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqmatch TemplateRemoveMatch
---@param ctrl? table
---@return Template
---@return string? err
function TemplateEntity:remove(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "remove",
    ctrl = ctrl,
...
function TemplateEntity:_run_op(ctx, post_done)
  local utility = self._utility
