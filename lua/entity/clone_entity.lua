...
local CloneEntity = {}
CloneEntity.__index = CloneEntity


function CloneEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CloneEntity)
  self._name = "clone"
  self._client = client
...
function CloneEntity:get_name()
  return self._name
end


function CloneEntity:make()
  local opts = {}
...
function CloneEntity:data_set(args)
  if args ~= nil then
...
function CloneEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CloneEntity:match_set(args)
  if args ~= nil then
...
function CloneEntity:match_get()
...
function CloneEntity:stream(action, args, callopts)
...
---@param reqdata CloneCreateData
---@param ctrl? table
---@return Clone
---@return string? err
function CloneEntity:create(reqdata, ctrl)
  local utility = self._utility
...
function CloneEntity:_run_op(ctx, post_done)
  local utility = self._utility
