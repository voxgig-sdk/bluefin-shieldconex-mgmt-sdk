...
local UpdateResultEntity = {}
UpdateResultEntity.__index = UpdateResultEntity


function UpdateResultEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, UpdateResultEntity)
  self._name = "update_result"
  self._client = client
...
function UpdateResultEntity:get_name()
  return self._name
end


function UpdateResultEntity:make()
  local opts = {}
...
function UpdateResultEntity:data_set(args)
  if args ~= nil then
...
function UpdateResultEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function UpdateResultEntity:match_set(args)
  if args ~= nil then
...
function UpdateResultEntity:match_get()
...
function UpdateResultEntity:stream(action, args, callopts)
...
---@param reqmatch UpdateResultListMatch
---@param ctrl? table
---@return UpdateResult[]
---@return string? err
function UpdateResultEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqdata UpdateResultCreateData
---@param ctrl? table
---@return UpdateResult
---@return string? err
function UpdateResultEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata UpdateResultUpdateData
---@param ctrl? table
---@return UpdateResult
---@return string? err
function UpdateResultEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function UpdateResultEntity:_run_op(ctx, post_done)
  local utility = self._utility
