...
require("bluefin-shieldconex-mgmt_types")
...
local BluefinShieldconexMgmtSDK = {}
BluefinShieldconexMgmtSDK.__index = BluefinShieldconexMgmtSDK
...
BluefinShieldconexMgmtSDK._make_feature = _make_feature


function BluefinShieldconexMgmtSDK.new(options)
  local self = setmetatable({}, BluefinShieldconexMgmtSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function BluefinShieldconexMgmtSDK:options_map()
...
function BluefinShieldconexMgmtSDK:get_utility()
  return Utility.copy(self._utility)
end


function BluefinShieldconexMgmtSDK:get_root_ctx()
  return self._rootctx
end


function BluefinShieldconexMgmtSDK:prepare(fetchargs)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function BluefinShieldconexMgmtSDK:Clone(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function BluefinShieldconexMgmtSDK:Partner(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function BluefinShieldconexMgmtSDK:Template(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function BluefinShieldconexMgmtSDK:Transaction(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function BluefinShieldconexMgmtSDK:UpdateResult(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function BluefinShieldconexMgmtSDK:User(data)
...
function BluefinShieldconexMgmtSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = BluefinShieldconexMgmtSDK.new(sdkopts)
  sdk.mode = "test"
...
return BluefinShieldconexMgmtSDK
