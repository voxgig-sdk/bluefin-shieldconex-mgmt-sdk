...
function runner.env_override(m)
  local live = runner.getenv("BLUEFINSHIELDCONEXMGMT_TEST_LIVE")
  local override = runner.getenv("BLUEFINSHIELDCONEXMGMT_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("BLUEFINSHIELDCONEXMGMT_TEST_EXPLAIN")
