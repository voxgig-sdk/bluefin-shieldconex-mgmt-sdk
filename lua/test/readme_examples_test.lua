...
local SDK_MODULE = "bluefin-shieldconex-mgmt_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["client"] = { ["test01"] = { id = "test01" } }, ["clone"] = { ["test01"] = { id = "test01" } }, ["partner"] = { ["test01"] = { id = "test01" } }, ["template"] = { ["test01"] = { id = "test01" } }, ["transaction"] = { ["test01"] = { id = "test01" } }, ["update_result"] = { ["test01"] = { id = "test01" } }, ["user"] = { ["test01"] = { id = "test01" } } } }'
