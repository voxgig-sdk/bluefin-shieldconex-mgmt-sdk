...
describe("UpdateResultDirect", function()
  it("should direct-list-update_result", function()
    local setup = update_result_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-update_result", setup.live and "live" or "unit")
...
function update_result_direct_setup(mockres)
