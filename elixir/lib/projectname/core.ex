# BluefinShieldconexMgmt SDK core runtime objects.
#
...
defmodule BluefinShieldconexMgmt.Control do
...
defmodule BluefinShieldconexMgmt.Spec do
  alias Voxgig.Struct, as: S
...
defmodule BluefinShieldconexMgmt.Result do
  alias Voxgig.Struct, as: S
...
defmodule BluefinShieldconexMgmt.Response do
  alias Voxgig.Struct, as: S
...
defmodule BluefinShieldconexMgmt.Operation do
  alias Voxgig.Struct, as: S
