...
defmodule BluefinShieldconexMgmt.Entity.Client do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "client", entopts)
  end
  ...
  # Returns the client entity map (BluefinShieldconexMgmt.Types.client/0) on
  # success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec load(map(), BluefinShieldconexMgmt.Types.client_load_match() | nil, map() | nil) :: term()
  ...
  # Returns a list of client entity maps (BluefinShieldconexMgmt.Types.client/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec list(map(), BluefinShieldconexMgmt.Types.client_list_match() | nil, map() | nil) :: term()
  ...
  # Returns the created client entity map (BluefinShieldconexMgmt.Types.client/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec create(map(), BluefinShieldconexMgmt.Types.client_create_data() | nil, map() | nil) :: term()
  ...
  # Returns the removed client entity map (BluefinShieldconexMgmt.Types.client/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec remove(map(), BluefinShieldconexMgmt.Types.client_remove_match() | nil, map() | nil) :: term()
