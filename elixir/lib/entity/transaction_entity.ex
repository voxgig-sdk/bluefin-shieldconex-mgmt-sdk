...
defmodule BluefinShieldconexMgmt.Entity.Transaction do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "transaction", entopts)
  end
  ...
  # Returns the transaction entity map (BluefinShieldconexMgmt.Types.transaction/0) on
  # success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec load(map(), BluefinShieldconexMgmt.Types.transaction_load_match() | nil, map() | nil) :: term()
  ...
  # Returns a list of transaction entity maps (BluefinShieldconexMgmt.Types.transaction/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec list(map(), BluefinShieldconexMgmt.Types.transaction_list_match() | nil, map() | nil) :: term()
