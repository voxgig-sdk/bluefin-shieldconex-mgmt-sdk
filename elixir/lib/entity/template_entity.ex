...
defmodule BluefinShieldconexMgmt.Entity.Template do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "template", entopts)
  end
  ...
  # Returns the template entity map (BluefinShieldconexMgmt.Types.template/0) on
  # success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec load(map(), BluefinShieldconexMgmt.Types.template_load_match() | nil, map() | nil) :: term()
  ...
  # Returns a list of template entity maps (BluefinShieldconexMgmt.Types.template/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec list(map(), BluefinShieldconexMgmt.Types.template_list_match() | nil, map() | nil) :: term()
  ...
  # Returns the created template entity map (BluefinShieldconexMgmt.Types.template/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec create(map(), BluefinShieldconexMgmt.Types.template_create_data() | nil, map() | nil) :: term()
  ...
  # Returns the removed template entity map (BluefinShieldconexMgmt.Types.template/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec remove(map(), BluefinShieldconexMgmt.Types.template_remove_match() | nil, map() | nil) :: term()
