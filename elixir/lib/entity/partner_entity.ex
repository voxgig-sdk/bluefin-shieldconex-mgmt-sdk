...
defmodule BluefinShieldconexMgmt.Entity.Partner do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "partner", entopts)
  end
  ...
  # Returns the partner entity map (BluefinShieldconexMgmt.Types.partner/0) on
  # success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec load(map(), BluefinShieldconexMgmt.Types.partner_load_match() | nil, map() | nil) :: term()
  ...
  # Returns a list of partner entity maps (BluefinShieldconexMgmt.Types.partner/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec list(map(), BluefinShieldconexMgmt.Types.partner_list_match() | nil, map() | nil) :: term()
  ...
  # Returns the created partner entity map (BluefinShieldconexMgmt.Types.partner/0)
  # on success; pipeline errors surface as the error value built by
  # Utility.make_error (shape is utility-configurable), hence term().
  @spec create(map(), BluefinShieldconexMgmt.Types.partner_create_data() | nil, map() | nil) :: term()
