...
defmodule BluefinShieldconexMgmt.Entity.Clone do
  ...
  def new(client, entopts \\ nil) do
    EntityBase.construct(__MODULE__, client, "clone", entopts)
  end
  ...
  # Returns the created clone entity map (BluefinShieldconexMgmt.Types.clone/0)
  ...
  @spec create(map(), BluefinShieldconexMgmt.Types.clone_create_data() | nil, map() | nil) :: term()
