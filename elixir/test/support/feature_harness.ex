...
defmodule BluefinShieldconexMgmt.FeatureHarness do
  alias Voxgig.Struct, as: S
  alias BluefinShieldconexMgmt.Helpers, as: H
  alias BluefinShieldconexMgmt.{Control, Spec, Result, Context, Features}

  # True when this SDK was generated with the named feature.
  def has_feature(name) do
    feature = S.getprop(BluefinShieldconexMgmt.Config.make_config(), "feature")
