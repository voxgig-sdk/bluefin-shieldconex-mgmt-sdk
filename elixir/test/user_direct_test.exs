# User direct test (offline, mock system.fetch)

defmodule BluefinShieldconexMgmt.UserDirectTest do
  use ExUnit.Case
  ...
  test "should direct load user" do
    canned = S.jm(["id", "direct01"])
    sdk = mk(canned)
    res = BluefinShieldconexMgmt.direct(sdk, H.deep(%{"path" => "/user/direct01", "method" => "GET", "params" => %{}}))
