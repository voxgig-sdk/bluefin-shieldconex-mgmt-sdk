...
#      (BluefinShieldconexMgmtSDK->test) against the real SDK. Captured output is scanned for
...
my $SDK_CLASS = 'BluefinShieldconexMgmtSDK';
...
# becomes BluefinShieldconexMgmtSDK->test(<fixtures>); a block that only uses $client gets
