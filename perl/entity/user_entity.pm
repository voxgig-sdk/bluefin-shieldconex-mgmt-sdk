# BluefinShieldconexMgmt SDK User entity
...
# Returns the current User data (hashref).
sub data_get {
  my ($self) = @_;
...
# Returns the current match filter (any subset of User fields).
sub match_get {
  my ($self) = @_;
...
# Load a single User.
#
# reqmatch: match criteria hashref (id/query fields; UserLoadMatch
...
# Returns the loaded User data (hashref); dies with BluefinShieldconexMgmtError
# on failure.
sub load {
