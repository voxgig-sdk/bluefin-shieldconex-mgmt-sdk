...
func registerSDKWords(r *eng.Registry, client *sdk.BluefinShieldconexMgmtSDK) {
...
func runOp(client *sdk.BluefinShieldconexMgmtSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
