...
import voxgig.bluefinshieldconexmgmtsdk.core.{Context, Entity, Helpers, SdkClient}
import voxgig.bluefinshieldconexmgmtsdk.utility.struct.Struct

// Client entity client for the BluefinShieldconexMgmt SDK.
class ClientEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("client", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new ClientEntity(this.client, opts)
  }
