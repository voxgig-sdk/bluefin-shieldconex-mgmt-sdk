...
// Clone entity client for the BluefinShieldconexMgmt SDK.
class CloneEntity(client0: SdkClient, entopts0: JMap[String, Object]) extends EntityBase("clone", client0, entopts0) {

  override def make(): Entity = {
    val opts = new LinkedHashMap[String, Object](this.entopts)
    new CloneEntity(this.client, opts)
  }
