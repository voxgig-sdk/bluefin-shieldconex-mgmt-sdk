...
class Utility private (noregister: Boolean) {
  ...
  val struct: voxgig.bluefinshieldconexmgmtsdk.utility.StructUtility.type = voxgig.bluefinshieldconexmgmtsdk.utility.StructUtility

  def this() = {
    this(false)
    voxgig.bluefinshieldconexmgmtsdk.utility.Register.registerAll(this)
  }
