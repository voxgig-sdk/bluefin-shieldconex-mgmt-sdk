...
public class CloneEntity extends EntityBase {

  public CloneEntity(SdkClient client, Map<String, Object> entopts) {
    super("clone", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new CloneEntity(this.client, opts);
  }
