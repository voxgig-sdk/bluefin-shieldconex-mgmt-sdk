...
def make_error_util(ctx, err):
    if ctx is None:
        ...
        ctx = BluefinShieldconexMgmtContext({}, None)
    ...
    result = ctx.result
    if result is None:
        result = BluefinShieldconexMgmtResult({})
    result.ok = False
    ...
    errmsg = ""
    if isinstance(err, BluefinShieldconexMgmtError):
        errmsg = err.msg
    ...
    sdk_err = BluefinShieldconexMgmtError("", msg, ctx)
