...
class BluefinShieldconexMgmtContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = BluefinShieldconexMgmtControl()
        ...
        if isinstance(sp, BluefinShieldconexMgmtSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, BluefinShieldconexMgmtResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, BluefinShieldconexMgmtResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return BluefinShieldconexMgmtOperation({})
        ...
        op = BluefinShieldconexMgmtOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return BluefinShieldconexMgmtError(code, msg, self)
