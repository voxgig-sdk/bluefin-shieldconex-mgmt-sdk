# BluefinShieldconexMgmt SDK utility: make_spec
...
$REGISTRY{make_spec} = sub {
  ...
  my $base = BluefinShieldconexMgmtHelpers::gp($options, 'base');
  $base = '' unless defined $base;
  my $prefix = BluefinShieldconexMgmtHelpers::gp($options, 'prefix');
  $prefix = '' unless defined $prefix;
  my $suffix = BluefinShieldconexMgmtHelpers::gp($options, 'suffix');
  $suffix = '' unless defined $suffix;

  my $parts = [];
  $parts = BluefinShieldconexMgmtHelpers::gp($point, 'parts') if $point;
  ...
  my $allow_method = BluefinShieldconexMgmtHelpers::gpath($options, 'allow.method');
