...
static void test_primary_fetcher_live(void) {
  ...
  BluefinShieldconexMgmtSDK* live = projectname_sdk_new(
...
static void test_primary_fetcher_blocked_test_mode(void) {
  BluefinShieldconexMgmtSDK* blocked = projectname_sdk_new(
...
static void test_primary_new_sdk_smoke(void) {
  BluefinShieldconexMgmtSDK* client = projectname_sdk_new(v_undef());
