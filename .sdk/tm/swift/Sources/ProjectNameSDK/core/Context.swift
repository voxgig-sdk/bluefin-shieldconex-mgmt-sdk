// BluefinShieldconexMgmt SDK - operation context.
//
...
public final class Context {
  ...
  public var client: BluefinShieldconexMgmtSDK?
  ...
  public init(_ ctxmap: [String: Any?]?, _ basectx: Context?) {
    ...
    // Client
    if let sdk = ctxProp(ctxmap, "client") as? BluefinShieldconexMgmtSDK { client = sdk }
  ...
  public func makeError(_ code: String, _ msg: String) -> BluefinShieldconexMgmtError {
