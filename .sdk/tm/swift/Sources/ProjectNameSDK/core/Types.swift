// BluefinShieldconexMgmt SDK - core contracts.
...
// BluefinShieldconexMgmtEntityBase which implements this.
...
// Throws (typically BluefinShieldconexMgmtError) on transport-level failure. A returned
