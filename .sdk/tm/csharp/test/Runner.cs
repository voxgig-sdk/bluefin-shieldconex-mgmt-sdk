// BluefinShieldconexMgmt SDK test runner - shared infrastructure for the generated
...
public static class TestRunner
{
    ...
    public static int LiveDelayMs()
    {
        ...
        {
            var n = BluefinShieldconexMgmtSdk.Helpers.ToInt(v);
            if (n >= 0)
            {
                return n;
            }
        ...
        BluefinShieldconexMgmtSDK? client, Utility? utility)
    {
            ...
            resRaw is Dictionary<string, object?> resMap)
        {
            ...
            {
                ctx.Result.Err = new BluefinShieldconexMgmtError("", msg, null);
            }
        }
    ...
    public static Exception? ErrFromMap(Dictionary<string, object?>? m)
    {
        ...
        return new BluefinShieldconexMgmtError(code, msg, null);
    }
