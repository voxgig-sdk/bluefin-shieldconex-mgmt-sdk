...
internal static class Fh
{
    ...
    {
        return err is BluefinShieldconexMgmtError se ? se.Code : "";
    }
}
...
public class FeaturePagingTest
{
    ...
    public void StampsPageLimitAndReadsHeaders()
    {
        ...
        Assert.Equal(2, BluefinShieldconexMgmtSdk.Helpers.ToInt(paging["nextPage"]));
        Assert.Equal(5, BluefinShieldconexMgmtSdk.Helpers.ToInt(paging["totalCount"]));
