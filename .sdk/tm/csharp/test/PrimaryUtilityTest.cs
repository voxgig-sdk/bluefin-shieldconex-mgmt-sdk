...
public class PrimaryUtilityTest
{
    ...
    private readonly BluefinShieldconexMgmtSDK _client;
    ...
    public PrimaryUtilityTest()
    {
        ...
        _client = BluefinShieldconexMgmtSDK.TestSDK(null, null);
        _utility = _client.GetUtility();
    }

    // Helper: create basic test context.
    private Context MakeTestCtx(BluefinShieldconexMgmtSDK client, Utility utility,
    ...
    private Context MakeTestFullCtx(BluefinShieldconexMgmtSDK client, Utility utility)
    {
    ...
    {
        var hookClient = BluefinShieldconexMgmtSDK.TestSDK(null, null);
    ...
    {
        var initClient = BluefinShieldconexMgmtSDK.TestSDK(null, null);
    ...
    public void FetcherBlockedTestMode()
    {
        ...
        var blockedClient = new BluefinShieldconexMgmtSDK(new Dictionary<string, object?>
        {
            ["system"] = new Dictionary<string, object?>
            {
                ["fetch"] = (Func<string, Dictionary<string, object?>, Dictionary<string, object?>>)
    ...
    public void MakeSpecBasic()
    {
        ...
        var specClient = BluefinShieldconexMgmtSDK.TestSDK(null, setupOpts);
    ...
    public void PrepareAuthBasic()
    {
        ...
        var authClient = BluefinShieldconexMgmtSDK.TestSDK(null, setupOpts);
