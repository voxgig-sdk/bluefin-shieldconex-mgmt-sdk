...
// BluefinShieldconexMgmt SDK audit feature
...
class BluefinShieldconexMgmtAuditFeature extends BluefinShieldconexMgmtBaseFeature
{
    ...
    private function _emit(BluefinShieldconexMgmtContext $ctx, string $outcome): void
    {
