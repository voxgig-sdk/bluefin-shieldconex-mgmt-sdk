...
// BluefinShieldconexMgmt SDK ratelimit feature
...
class BluefinShieldconexMgmtRatelimitFeature extends BluefinShieldconexMgmtBaseFeature
{
    ...
    private function _acquire(BluefinShieldconexMgmtContext $ctx): void
    {
    ...
    private function _track(BluefinShieldconexMgmtContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
