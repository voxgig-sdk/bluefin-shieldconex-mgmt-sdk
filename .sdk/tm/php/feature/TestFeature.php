...
class BluefinShieldconexMgmtTestFeature extends BluefinShieldconexMgmtBaseFeature
{
    ...
    public function init(BluefinShieldconexMgmtContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (BluefinShieldconexMgmtContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
            ...
            if ($op->name === 'load') {
                ...
                $id = BluefinShieldconexMgmtParam::call($fctx, 'id');
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (BluefinShieldconexMgmtContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(BluefinShieldconexMgmtContext $ctx, $op, $args): array
    {
        ...
        foreach ($keys as $k) {
            ...
            if ($is_id || $in_reqd) {
                $v = BluefinShieldconexMgmtParam::call($ctx, $k);
