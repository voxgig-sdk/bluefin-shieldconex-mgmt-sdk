...
// BluefinShieldconexMgmt SDK clienttrack feature
...
class BluefinShieldconexMgmtClienttrackFeature extends BluefinShieldconexMgmtBaseFeature
{
    ...
    public function PostConstruct(BluefinShieldconexMgmtContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'BluefinShieldconexMgmt-SDK';
