...
// BluefinShieldconexMgmt SDK timeout feature
...
class BluefinShieldconexMgmtTimeoutFeature extends BluefinShieldconexMgmtBaseFeature
{
    ...
    private function _with_timeout(BluefinShieldconexMgmtContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(BluefinShieldconexMgmtContext $_ctx, float $ms): void
    {
        $client = $this->client;
