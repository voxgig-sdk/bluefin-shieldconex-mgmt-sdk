...
// BluefinShieldconexMgmt SDK streaming feature
...
class BluefinShieldconexMgmtStreamingFeature extends BluefinShieldconexMgmtBaseFeature
{
    ...
    private function _iterate(BluefinShieldconexMgmtResult $result): \Generator
    {
    ...
    private function _streamable(BluefinShieldconexMgmtContext $ctx): bool
    {
