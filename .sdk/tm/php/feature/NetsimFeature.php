...
// BluefinShieldconexMgmt SDK netsim feature
...
class BluefinShieldconexMgmtNetsimFeature extends BluefinShieldconexMgmtBaseFeature
{
    ...
    private function _simulate(BluefinShieldconexMgmtContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(BluefinShieldconexMgmtContext $ctx, array $applied): void
    {
        $client = $this->client;
