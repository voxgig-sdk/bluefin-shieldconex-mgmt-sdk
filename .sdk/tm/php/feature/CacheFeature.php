...
// BluefinShieldconexMgmt SDK cache feature
...
class BluefinShieldconexMgmtCacheFeature extends BluefinShieldconexMgmtBaseFeature
{
    ...
    private function _through(BluefinShieldconexMgmtContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
