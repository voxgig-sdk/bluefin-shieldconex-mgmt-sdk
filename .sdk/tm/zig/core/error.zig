// BluefinShieldconexMgmtError: the SDK error type (mirrors go core/error.go / the rust
...
pub const BluefinShieldconexMgmtError = struct {
    sdk: []const u8 = "BluefinShieldconexMgmt",
    code: []const u8,
    msg: []const u8,
    ...
    pub fn make(code: []const u8, msg: []const u8) *BluefinShieldconexMgmtError {
        const e = mem.a().create(BluefinShieldconexMgmtError) catch unreachable;
        e.* = .{ .sdk = "BluefinShieldconexMgmt", .code = code, .msg = msg };
        return e;
    }
};
