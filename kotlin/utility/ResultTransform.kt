...
fun resultBasic(ctx: Context): voxgig.bluefinshieldconexmgmtsdk.core.Result {
...
fun resultBody(ctx: Context): voxgig.bluefinshieldconexmgmtsdk.core.Result {
  val response = ctx.response
  val result = ctx.result
...
fun resultHeaders(ctx: Context): voxgig.bluefinshieldconexmgmtsdk.core.Result {
  val response = ctx.response
  val result = ctx.result
