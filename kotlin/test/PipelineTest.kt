...
class PipelineTest {
  ...
  private fun plClient(sdkopts: MutableMap<String, Any?>?): BluefinShieldconexMgmtSDK {
    return BluefinShieldconexMgmtSDK.testSDK(null, sdkopts)
  }

  private fun plCtx(client: BluefinShieldconexMgmtSDK, utility: Utility, ctrl: MutableMap<String, Any?>?): Context {
  ...
  private fun names(client: BluefinShieldconexMgmtSDK): String {
