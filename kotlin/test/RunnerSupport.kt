...
object RunnerSupport {
  ...
  fun makeCtxFromMap(ctxmapIn: MutableMap<String, Any?>?, client: BluefinShieldconexMgmtSDK?, utility: Utility?): Context {
  ...
  fun fixctx(ctx: Context?, client: BluefinShieldconexMgmtSDK?) {
