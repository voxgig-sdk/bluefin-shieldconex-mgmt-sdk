...
import voxgig.bluefinshieldconexmgmtsdk.sdktest.RunnerSupport.getSpec
import voxgig.bluefinshieldconexmgmtsdk.sdktest.RunnerSupport.loadTestSpec
import voxgig.bluefinshieldconexmgmtsdk.sdktest.RunnerSupport.makeCtxFromMap
import voxgig.bluefinshieldconexmgmtsdk.sdktest.RunnerSupport.runset
...
class PrimaryUtilityTest {
  ...
  private fun client(): BluefinShieldconexMgmtSDK = BluefinShieldconexMgmtSDK.testSDK()

  private fun makeTestCtx(client: BluefinShieldconexMgmtSDK, utility: Utility, overrides: MutableMap<String, Any?>?): Context {
  ...
  private fun makeTestFullCtx(client: BluefinShieldconexMgmtSDK, utility: Utility): Context {
  ...
  fun fetcherLive() {
    ...
    val liveClient = BluefinShieldconexMgmtSDK(
      fhMap(
        "system",
        fhMap(
          "fetch",
  ...
  fun fetcherBlockedTestMode() {
    val blockedClient = BluefinShieldconexMgmtSDK(
      fhMap(
        "system",
  ...
  fun makeSpecBasic() {
    ...
    val specClient = BluefinShieldconexMgmtSDK.testSDK(null, setupOpts)
  ...
  fun prepareAuthBasic() {
    ...
    val authClient = BluefinShieldconexMgmtSDK.testSDK(null, setupOpts)
