...
using BluefinShieldconexMgmtSdk.Feature;

namespace BluefinShieldconexMgmtSdk;

public class BluefinShieldconexMgmtSDK
{
    ...
    public BluefinShieldconexMgmtSDK(Dictionary<string, object?>? options = null)
    {
    ...
    public BluefinShieldconexMgmtEntityBase Client(Dictionary<string, object?>? entopts = null)
    {
        return new global::BluefinShieldconexMgmtSdk.Entity.ClientEntity(this, entopts);
    }

    // Clone returns a Clone entity bound to this client.
    // Idiomatic usage: client.Clone().List(null) or
    // client.Clone().Load(new() { ["id"] = ... }).
    public BluefinShieldconexMgmtEntityBase Clone(Dictionary<string, object?>? entopts = null)
    {
        return new global::BluefinShieldconexMgmtSdk.Entity.CloneEntity(this, entopts);
    }

    // Partner returns a Partner entity bound to this client.
    // Idiomatic usage: client.Partner().List(null) or
    // client.Partner().Load(new() { ["id"] = ... }).
    public BluefinShieldconexMgmtEntityBase Partner(Dictionary<string, object?>? entopts = null)
    {
        return new global::BluefinShieldconexMgmtSdk.Entity.PartnerEntity(this, entopts);
    }

    // Template returns a Template entity bound to this client.
    // Idiomatic usage: client.Template().List(null) or
    // client.Template().Load(new() { ["id"] = ... }).
    public BluefinShieldconexMgmtEntityBase Template(Dictionary<string, object?>? entopts = null)
    {
        return new global::BluefinShieldconexMgmtSdk.Entity.TemplateEntity(this, entopts);
    }

    // Transaction returns a Transaction entity bound to this client.
    // Idiomatic usage: client.Transaction().List(null) or
    // client.Transaction().Load(new() { ["id"] = ... }).
    public BluefinShieldconexMgmtEntityBase Transaction(Dictionary<string, object?>? entopts = null)
    {
        return new global::BluefinShieldconexMgmtSdk.Entity.TransactionEntity(this, entopts);
    }

    // UpdateResult returns a UpdateResult entity bound to this client.
    // Idiomatic usage: client.UpdateResult().List(null) or
    // client.UpdateResult().Load(new() { ["id"] = ... }).
    public BluefinShieldconexMgmtEntityBase UpdateResult(Dictionary<string, object?>? entopts = null)
    {
        return new global::BluefinShieldconexMgmtSdk.Entity.UpdateResultEntity(this, entopts);
    }

    // User returns a User entity bound to this client.
    // Idiomatic usage: client.User().List(null) or
    // client.User().Load(new() { ["id"] = ... }).
    public BluefinShieldconexMgmtEntityBase User(Dictionary<string, object?>? entopts = null)
    {
        return new global::BluefinShieldconexMgmtSdk.Entity.UserEntity(this, entopts);
    }


    public static BluefinShieldconexMgmtSDK TestSDK(Dictionary<string, object?>? testopts,
        Dictionary<string, object?>? sdkopts)
    {
        ...
        var sdk = new BluefinShieldconexMgmtSDK(sdkopts)
        {
            Mode = "test",
        };
