...
public abstract class BluefinShieldconexMgmtEntityBase : IEntity
{
    protected string name;
    protected BluefinShieldconexMgmtSDK client;
    ...
    protected BluefinShieldconexMgmtEntityBase(BluefinShieldconexMgmtSDK client,
