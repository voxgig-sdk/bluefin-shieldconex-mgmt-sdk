...
public class CloneEntity : BluefinShieldconexMgmtEntityBase
{
    public CloneEntity(BluefinShieldconexMgmtSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "clone")
    {
    }

    public override IEntity Make()
    {
        return new CloneEntity(client, CloneOpts());
    }
