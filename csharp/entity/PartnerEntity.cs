...
public class PartnerEntity : BluefinShieldconexMgmtEntityBase
{
    public PartnerEntity(BluefinShieldconexMgmtSDK client, Dictionary<string, object?>? entopts = null)
