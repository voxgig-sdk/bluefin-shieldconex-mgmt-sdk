...
public class ClientEntity : BluefinShieldconexMgmtEntityBase
{
    public ClientEntity(BluefinShieldconexMgmtSDK client, Dictionary<string, object?>? entopts = null)
        : base(client, entopts, "client")
    {
    }

    public override IEntity Make()
    {
        return new ClientEntity(client, CloneOpts());
    }
