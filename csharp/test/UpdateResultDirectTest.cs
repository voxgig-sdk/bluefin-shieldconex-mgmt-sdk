// update_result direct API tests (generated from the API model).
...
public class UpdateResultDirectTest
{
    [Fact]
    public void DirectList()
    {
        var setup = UpdateResultDirectSetup(new List<object?>
        {
        ...
        var (_shouldSkip, _) = TestRunner.IsControlSkipped(
            "direct", "direct-list-update_result", _mode);
        if (_shouldSkip)
        {
    ...
    private class UpdateResultDirectSetupResult
    {
    ...
    private static UpdateResultDirectSetupResult UpdateResultDirectSetup(object? mockres)
    {
        ...
        {
            ["BLUEFINSHIELDCONEXMGMT_TEST_UPDATE_RESULT_ENTID"] = new Dictionary<string, object?>(),
        ...
        if (live)
        {
            ...
            var entidRaw = env["BLUEFINSHIELDCONEXMGMT_TEST_UPDATE_RESULT_ENTID"];
            ...
            return new UpdateResultDirectSetupResult
            {
                Client = liveClient,
                Calls = calls,
                Live = true,
