// User entity client (generated). Shared entity runtime (data/match
...
public:
  UserEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("user", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<UserEntity>(this->client, opts);
  }
