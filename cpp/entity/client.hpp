// Client entity client (generated). Shared entity runtime (data/match
...
public:
  ClientEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("client", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<ClientEntity>(this->client, opts);
  }
