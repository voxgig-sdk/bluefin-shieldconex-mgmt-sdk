// Partner entity client (generated). Shared entity runtime (data/match
...
class PartnerEntity : public EntityBase {
public:
  PartnerEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("partner", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<PartnerEntity>(this->client, opts);
  }
