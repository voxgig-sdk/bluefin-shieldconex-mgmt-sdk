// Transaction entity client (generated). Shared entity runtime (data/match
...
class TransactionEntity : public EntityBase {
public:
  TransactionEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("transaction", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<TransactionEntity>(this->client, opts);
  }
