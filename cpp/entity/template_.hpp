// Template entity client (generated). Shared entity runtime (data/match
...
class TemplateEntity : public EntityBase {
public:
  TemplateEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("template", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<TemplateEntity>(this->client, opts);
  }
