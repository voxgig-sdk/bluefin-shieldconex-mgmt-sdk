// UpdateResult entity client (generated). Shared entity runtime (data/match
...
class UpdateResultEntity : public EntityBase {
public:
  UpdateResultEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("update_result", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<UpdateResultEntity>(this->client, opts);
  }
