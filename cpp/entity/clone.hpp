// Clone entity client (generated). Shared entity runtime (data/match
...
class CloneEntity : public EntityBase {
public:
  CloneEntity(SdkClient* client, Value entopts = Value::undef())
      : EntityBase("clone", client, entopts) {}
  ...
  EntityPtr make() override {
    ...
    return std::make_shared<CloneEntity>(this->client, opts);
  }
