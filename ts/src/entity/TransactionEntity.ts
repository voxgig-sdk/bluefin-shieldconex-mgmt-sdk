...
class TransactionEntity extends BluefinShieldconexMgmtEntityBase<Transaction> {

  constructor(client: BluefinShieldconexMgmtSDK, entopts: any) {
    super(client, entopts)
    this.name = 'transaction'
    this.name_ = 'transaction'
    this.Name = 'Transaction'
  }


  make(this: TransactionEntity) {
    return new TransactionEntity(this._client, this.entopts())
  }
  ...
  async load(this: any, reqmatch?: TransactionLoadMatch, ctrl?: Control): Promise<Transaction> {
    ...
    try {
      ...
      if (err) {
        ...
        // Promise<Transaction> return stays clean under strict null checks.
