...
require_relative 'BluefinShieldconexMgmt_types'
...
class BluefinShieldconexMgmtSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = BluefinShieldconexMgmtHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = BluefinShieldconexMgmtHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, BluefinShieldconexMgmtFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    BluefinShieldconexMgmtUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = BluefinShieldconexMgmtHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = BluefinShieldconexMgmtHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = BluefinShieldconexMgmtHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def direct(fetchargs = {})
    ...
    rescue BluefinShieldconexMgmtError => err
    ...
    if fetched.is_a?(Hash)
      status = BluefinShieldconexMgmtHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  # Canonical facade: client.Clone.list / client.Clone.load({ "id" => ... })
  def Clone(data = nil)
    require_relative 'entity/clone_entity'
    CloneEntity.new(self, data)
  end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = BluefinShieldconexMgmtSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
