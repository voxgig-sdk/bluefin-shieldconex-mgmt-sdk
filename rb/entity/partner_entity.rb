...
class PartnerEntity
  ...
  def make
    opts = @_entopts.dup
    PartnerEntity.new(@_client, opts)
  end
  ...
  # @return [Partner, Hash] the current Partner data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Partner fields)
  def match_get
  ...
  #
  # @param reqmatch [PartnerLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Partner.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Partner, Hash] the loaded Partner; raises BluefinShieldconexMgmtError on failure
  ...
  #
  # @param reqmatch [PartnerListMatch, Hash, nil] match filter (any subset of
  #   Partner fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Partner>, Array] the matching Partner items; raises BluefinShieldconexMgmtError on failure
  ...
  #
  # @param reqdata [PartnerCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Partner, Hash] the created Partner; raises BluefinShieldconexMgmtError on failure
