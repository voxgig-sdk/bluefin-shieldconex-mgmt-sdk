...
class CloneEntity
  ...
  # @return [Clone, Hash] the current Clone data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Clone fields)
  def match_get
  ...
  # Create a new Clone.
  #
  # @param reqdata [CloneCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Clone, Hash] the created Clone; raises BluefinShieldconexMgmtError on failure
