...
class UpdateResultEntity
  ...
  def make
    opts = @_entopts.dup
    UpdateResultEntity.new(@_client, opts)
  end
  ...
  # @return [UpdateResult, Hash] the current UpdateResult data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of UpdateResult fields)
  def match_get
  ...
  #
  # @param reqmatch [UpdateResultListMatch, Hash, nil] match filter (any subset of
  #   UpdateResult fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<UpdateResult>, Array] the matching UpdateResult items; raises BluefinShieldconexMgmtError on failure
  ...
  #
  # @param reqdata [UpdateResultCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [UpdateResult, Hash] the created UpdateResult; raises BluefinShieldconexMgmtError on failure
  ...
  #
  # @param reqdata [UpdateResultUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [UpdateResult, Hash] the updated UpdateResult; raises BluefinShieldconexMgmtError on failure
