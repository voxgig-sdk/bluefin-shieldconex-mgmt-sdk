...
class TemplateEntity
  ...
  def make
    opts = @_entopts.dup
    TemplateEntity.new(@_client, opts)
  end
  ...
  # @return [Template, Hash] the current Template data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Template fields)
  def match_get
  ...
  #
  # @param reqmatch [TemplateLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Template.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Template, Hash] the loaded Template; raises BluefinShieldconexMgmtError on failure
  ...
  #
  # @param reqmatch [TemplateListMatch, Hash, nil] match filter (any subset of
  #   Template fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Template>, Array] the matching Template items; raises BluefinShieldconexMgmtError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Template, Hash] the created Template; raises BluefinShieldconexMgmtError on failure
  ...
  #
  # @param reqmatch [TemplateRemoveMatch, Hash, nil] match criteria (id/query fields)
  # @param ctrl [Object, nil] optional per-call control
  # @return [Template, Hash] the removed Template; raises BluefinShieldconexMgmtError on failure
