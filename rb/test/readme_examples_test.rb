...
#      offline in seeded test mode (BluefinShieldconexMgmtSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "BluefinShieldconexMgmt_sdk.rb")
  SDK_CLASS = "BluefinShieldconexMgmtSDK"
  ...
  SDK_BASE = "BluefinShieldconexMgmt_sdk"
