// Clone entity client (generated — mirrors the go/rust Entity fragment).
...
pub const CloneEntity = struct {
    ...
    pub fn new(client: *sdk.BluefinShieldconexMgmtSDK, entopts_in: Value) *CloneEntity {
        ...
        const e = h.A().create(CloneEntity) catch unreachable;
        e.* = .{
            .name = "clone",
            .client = client,
    ...
    fn ent_ctx(self: *CloneEntity) *Context {
        return self.entctx orelse unreachable;
    }

    fn opError(self: *CloneEntity, ctx: *Context) OpResult {
        const v = self.utility.make_error(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn doneResult(self: *CloneEntity, ctx: *Context) OpResult {
        const v = self.utility.done(ctx) catch return .{ .err = ctx.pending_err.? };
        return .{ .ok = v };
    }

    fn run_op(self: *CloneEntity, ctx: *Context, post_done: *const fn (*CloneEntity, *Context) void) OpResult {
    ...
    pub fn stream(self: *CloneEntity, action: []const u8, args: Value, callopts: Value) []Value {
        const utility = self.utility;
    ...
    fn e_of(p: *anyopaque) *CloneEntity {
    ...
    fn v_make(p: *anyopaque) Entity {
        ...
        return CloneEntity.new(self.client, opts).asEntity();
    }
    ...
    pub fn asEntity(self: *CloneEntity) Entity {
        return .{ .ptr = @ptrCast(self), .vtable = &entity_vtable };
    }

    fn data_impl(self: *CloneEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
    ...
    fn matchv_impl(self: *CloneEntity, args: ?Value) Value {
        if (args) |arg| {
            if (!h.is_noval(arg)) {
                const cloned = h.to_map(h.clone(arg));
    ...
    pub fn load(self: *CloneEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("load", self.name) };
    }

    pub fn list(self: *CloneEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
    ...
    pub fn create(self: *CloneEntity, reqdata: Value, ctrl: Value) OpResult {
    ...
    fn create_post_done(self: *CloneEntity, ctx: *Context) void {
    ...
    pub fn update(self: *CloneEntity, _reqdata: Value, _ctrl: Value) OpResult {
        _ = _reqdata;
        _ = _ctrl;
        return .{ .err = h.unsupported_op("update", self.name) };
    }

    pub fn remove(self: *CloneEntity, _reqmatch: Value, _ctrl: Value) OpResult {
        _ = _reqmatch;
        _ = _ctrl;
