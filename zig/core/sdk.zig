// BluefinShieldconexMgmtSDK client (generated — mirrors the go/rust Main fragment).
...
pub const BluefinShieldconexMgmtSDK = struct {
    mode: []const u8 = "live",
    options: Value = .{ .null = {} },
    utility: *Utility,
    ...
    pub fn new(options: Value) *BluefinShieldconexMgmtSDK {
        const sdk = h.A().create(BluefinShieldconexMgmtSDK) catch unreachable;
        sdk.* = .{
            .mode = "live",
            .options = h.vnull(),
            .utility = Utility.new(),
    ...
    pub fn options_map(self: *BluefinShieldconexMgmtSDK) Value {
        return h.clone(self.options);
    }

    pub fn get_utility(self: *BluefinShieldconexMgmtSDK) *Utility {
        return Utility.copy(self.utility);
    }

    pub fn get_root_ctx(self: *BluefinShieldconexMgmtSDK) *Context {
        return self.rootctx orelse unreachable;
    }

    pub fn prepare(self: *BluefinShieldconexMgmtSDK, fetchargs_in: Value) E!Value {
    ...
    pub fn direct(self: *BluefinShieldconexMgmtSDK, fetchargs_in: Value) Value {
        const utility = self.utility;
    ...
    pub fn clone(self: *@This(), entopts: Value) *@import("../entity/clone.zig").CloneEntity {
        return @import("../entity/clone.zig").CloneEntity.new(self, entopts);
    }
    ...
    pub fn template(self: *@This(), entopts: Value) *@import("../entity/template.zig").TemplateEntity {
        return @import("../entity/template.zig").TemplateEntity.new(self, entopts);
    }
...
pub fn test_sdk(testopts_in: Value, sdkopts_in: Value) *BluefinShieldconexMgmtSDK {
    ...
    const sdk = BluefinShieldconexMgmtSDK.new(sdkopts);
    sdk.mode = "test";
