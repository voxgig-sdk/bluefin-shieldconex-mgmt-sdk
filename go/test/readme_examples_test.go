...
const testSeed = `map[string]any{"entity": map[string]any{"client": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "clone": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "partner": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "template": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "transaction": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "update_result": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "user": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
