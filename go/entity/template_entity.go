...
func NewTemplateEntity(client *core.BluefinShieldconexMgmtSDK, entopts map[string]any) *TemplateEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TemplateEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTemplateEntity(e.client, opts)
}

func (e *TemplateEntity) Data(args ...any) any {
...
func (e *TemplateEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Template; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TemplateEntity) DataTyped(data ...Template) Template {
	if len(data) > 0 {
		return typedFrom[Template](e.Data(asMap(data[0])))
	}
	return typedFrom[Template](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Template (all fields
// optional at the wire level).
func (e *TemplateEntity) MatchTyped(match ...Template) Template {
	if len(match) > 0 {
		return typedFrom[Template](e.Match(asMap(match[0])))
	}
	return typedFrom[Template](e.Match())
}
...
func (e *TemplateEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TemplateEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TemplateLoadMatch and returns an Template. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TemplateEntity) LoadTyped(reqmatch TemplateLoadMatch, ctrl map[string]any) (Template, error) {
...
func (e *TemplateEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// TemplateListMatch and returns []Template. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *TemplateEntity) ListTyped(reqmatch TemplateListMatch, ctrl map[string]any) ([]Template, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Template](res), nil
}
...
func (e *TemplateEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
// TemplateRemoveMatch and returns an Template. It delegates to the untyped
// Remove (identical runtime) and converts at the typed boundary.
func (e *TemplateEntity) RemoveTyped(reqmatch TemplateRemoveMatch, ctrl map[string]any) (Template, error) {
