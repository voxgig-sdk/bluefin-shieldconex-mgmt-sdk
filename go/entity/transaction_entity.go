...
func NewTransactionEntity(client *core.BluefinShieldconexMgmtSDK, entopts map[string]any) *TransactionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TransactionEntity) GetName() string { return e.name }

func (e *TransactionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTransactionEntity(e.client, opts)
}

func (e *TransactionEntity) Data(args ...any) any {
...
func (e *TransactionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Transaction; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TransactionEntity) DataTyped(data ...Transaction) Transaction {
	if len(data) > 0 {
		return typedFrom[Transaction](e.Data(asMap(data[0])))
	}
	return typedFrom[Transaction](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Transaction (all fields
// optional at the wire level).
func (e *TransactionEntity) MatchTyped(match ...Transaction) Transaction {
	if len(match) > 0 {
		return typedFrom[Transaction](e.Match(asMap(match[0])))
	}
	return typedFrom[Transaction](e.Match())
}
...
func (e *TransactionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TransactionEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TransactionLoadMatch and returns an Transaction. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TransactionEntity) LoadTyped(reqmatch TransactionLoadMatch, ctrl map[string]any) (Transaction, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Transaction{}, err
	}
	return typedFrom[Transaction](res), nil
}
...
func (e *TransactionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TransactionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TransactionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TransactionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
