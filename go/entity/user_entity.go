...
func NewUserEntity(client *core.BluefinShieldconexMgmtSDK, entopts map[string]any) *UserEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UserEntity) List(_ map[string]any, _ map[string]any) (any, error) {
