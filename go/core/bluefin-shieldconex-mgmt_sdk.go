...
type BluefinShieldconexMgmtSDK struct {
	Mode     string
...
func (sdk *BluefinShieldconexMgmtSDK) OptionsMap() map[string]any {
...
func (sdk *BluefinShieldconexMgmtSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *BluefinShieldconexMgmtSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *BluefinShieldconexMgmtSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *BluefinShieldconexMgmtSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *BluefinShieldconexMgmtSDK) Client(data map[string]any) BluefinShieldconexMgmtEntity {
...
func (sdk *BluefinShieldconexMgmtSDK) Clone(data map[string]any) BluefinShieldconexMgmtEntity {
...
func (sdk *BluefinShieldconexMgmtSDK) Partner(data map[string]any) BluefinShieldconexMgmtEntity {
...
func (sdk *BluefinShieldconexMgmtSDK) Template(data map[string]any) BluefinShieldconexMgmtEntity {
...
func (sdk *BluefinShieldconexMgmtSDK) Transaction(data map[string]any) BluefinShieldconexMgmtEntity {
...
func (sdk *BluefinShieldconexMgmtSDK) UpdateResult(data map[string]any) BluefinShieldconexMgmtEntity {
...
func (sdk *BluefinShieldconexMgmtSDK) User(data map[string]any) BluefinShieldconexMgmtEntity {
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *BluefinShieldconexMgmtSDK {
	...
	sdk := NewBluefinShieldconexMgmtSDK(sdkopts)
	sdk.Mode = "test"
