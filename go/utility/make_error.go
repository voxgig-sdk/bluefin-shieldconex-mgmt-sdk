...
import "github.com/voxgig-sdk/bluefin-shieldconex-mgmt-sdk/go/core"
...
func makeErrorUtil(ctx *core.Context, err error) (any, error) {
	...
	sdkErr := &core.BluefinShieldconexMgmtError{
	...
	if se, ok := err.(*core.BluefinShieldconexMgmtError); ok {
		sdkErr.Code = se.Code
	}
