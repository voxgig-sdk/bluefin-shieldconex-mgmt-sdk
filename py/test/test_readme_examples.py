# BluefinShieldconexMgmt SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions BluefinShieldconexMgmtSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both BluefinShieldconexMgmtSDK(...) and BluefinShieldconexMgmtSDK.test(...) become
#      BluefinShieldconexMgmtSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "bluefinshieldconexmgmt_sdk"
_SDK_CLASS = "BluefinShieldconexMgmtSDK"
