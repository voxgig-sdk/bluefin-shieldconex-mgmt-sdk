...
final class PrimaryUtilityTest: XCTestCase {
  ...
  private var client: BluefinShieldconexMgmtSDK!
  private var utility: Utility!

  override func setUp() {
    super.setUp()
    primary = SdkRunner.loadPrimary()
    client = BluefinShieldconexMgmtSDK.testSDK(nil, nil)
  ...
  private func makeTestCtx(_ client: BluefinShieldconexMgmtSDK, _ utility: Utility,
  ...
  private func makeTestFullCtx(_ client: BluefinShieldconexMgmtSDK, _ utility: Utility) -> Context {
  ...
  func testFeatureHookBasic() {
    let hookClient = BluefinShieldconexMgmtSDK.testSDK(nil, nil)
  ...
  func testFeatureInitBasic() {
    let initClient = BluefinShieldconexMgmtSDK.testSDK(nil, nil)
  ...
  func testFetcherLive() throws {
    ...
    let liveClient = BluefinShieldconexMgmtSDK(opts)
  ...
  func testFetcherBlockedTestMode() {
    ...
    let opts = VMap()
    opts.entries["system"] = .map(vm(("fetch", .nat(fetch))))
    let blockedClient = BluefinShieldconexMgmtSDK(opts)
  ...
  func testMakeSpecBasic() {
    ...
    let specClient = BluefinShieldconexMgmtSDK.testSDK(nil, setupOpts)
  ...
  func testPrepareAuthBasic() {
    ...
    let authClient = BluefinShieldconexMgmtSDK.testSDK(nil, setupOpts)
