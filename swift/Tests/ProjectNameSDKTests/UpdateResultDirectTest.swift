// update_result direct API test (generated from the API model).

import XCTest

@testable import BluefinShieldconexMgmtSdk

final class UpdateResultDirectTest: XCTestCase {
  func testDirectMock() {
    ...
    let sdk = BluefinShieldconexMgmtSDK(opts)

    let args = VMap()
    args.entries["path"] = .string("/update_result")
