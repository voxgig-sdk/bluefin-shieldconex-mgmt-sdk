// BluefinShieldconexMgmtEntityBase - shared entity behaviour: construction, data/match
...
open class BluefinShieldconexMgmtEntityBase: Entity {
  var name: String
  var client: BluefinShieldconexMgmtSDK
  var utility: Utility
  var entopts: VMap
  var data = VMap()
  var match = VMap()
  ...
  public init(_ client: BluefinShieldconexMgmtSDK, _ entoptsIn: VMap?, _ name: String) {
  ...
  open func make() -> Entity {
    return BluefinShieldconexMgmtEntityBase(client, cloneOpts(), name)
  }
