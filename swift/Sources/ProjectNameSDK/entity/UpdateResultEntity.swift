...
public final class UpdateResultEntity: BluefinShieldconexMgmtEntityBase {
  public init(_ client: BluefinShieldconexMgmtSDK, _ entopts: VMap? = nil) {
    super.init(client, entopts, "update_result")
  }

  public override func make() -> Entity {
    return UpdateResultEntity(client, cloneOpts())
  }
