// BluefinShieldconexMgmt SDK — documentation dart-examples presence & completeness gate.
...
const String _sdkClass = 'BluefinShieldconexMgmtSDK';

// The API's capitalised semantic entities, used to spot a client.<Entity>()
// factory call inside a block.
const List<String> _entities = <String>['Client', 'Clone', 'Partner', 'Template', 'Transaction', 'UpdateResult', 'User'];
