...
Map<String, dynamic> envOverride(Map<String, dynamic> m) {
  ...
  if ('TRUE' == env['BLUEFINSHIELDCONEXMGMT_TEST_LIVE'] ||
      'TRUE' == env['BLUEFINSHIELDCONEXMGMT_TEST_OVERRIDE']) {
  ...
  m['BLUEFINSHIELDCONEXMGMT_TEST_EXPLAIN'] =
      env['BLUEFINSHIELDCONEXMGMT_TEST_EXPLAIN'] ?? m['BLUEFINSHIELDCONEXMGMT_TEST_EXPLAIN'];
