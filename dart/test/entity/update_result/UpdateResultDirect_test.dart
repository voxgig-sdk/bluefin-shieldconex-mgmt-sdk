...
void tests() {
  describe('UpdateResultDirect', () {
    ...
    test('direct-list-update_result', (t) async {
      final setup = directSetup([
        {'id': 'direct01'},
        {'id': 'direct02'}
      ]);
      if (maybeSkipControl(
          t, 'direct', 'direct-list-update_result', true == setup['live'])) {
        return;
      }
...
Map<String, dynamic> directSetup([dynamic mockres]) {
  ...
  final env = envOverride({
    'BLUEFINSHIELDCONEXMGMT_TEST_UPDATE_RESULT_ENTID': <String, dynamic>{},
  ...
  if (live) {
    ...
    dynamic idmap = env['BLUEFINSHIELDCONEXMGMT_TEST_UPDATE_RESULT_ENTID'];
