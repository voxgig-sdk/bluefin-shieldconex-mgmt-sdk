...
test('stream', (t) async {
      ...
      final plainent = plainsdk.Partner();
      final seen2 = [];
...
Map<String, dynamic> basicSetup([dynamic extra]) {
  ...
  dynamic idmap = transform(
      <dynamic>['partner01', 'partner02', 'partner03'],
      <String, dynamic>{
        '`\$PACK`': <dynamic>[
          '',
          <String, dynamic>{
  ...
  final idmapEnvVal =
      Platform.environment['BLUEFIN_SHIELDCONEX_MGMT_TEST_PARTNER_ENTID'];
