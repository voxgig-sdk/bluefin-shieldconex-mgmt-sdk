...
// Typed models: see ../BluefinShieldconexMgmtTypes.dart (Partner and the per-op request/match types).
class PartnerEntity extends BluefinShieldconexMgmtEntityBase {
  PartnerEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'partner';
    name_ = 'partner';
    Name = 'Partner';
  }
  ...
  PartnerEntity make() {
    return PartnerEntity(client, entopts());
  }


  /// Load a Partner by match (see PartnerLoadMatch in
  /// BluefinShieldconexMgmtTypes.dart). Returns the entity data map (Partner).
  ...
  /// List Partner entities by match (see PartnerListMatch in
  /// BluefinShieldconexMgmtTypes.dart). Returns a list of Partner entity instances.
  ...
  /// Create a Partner (see PartnerCreateData in
  /// BluefinShieldconexMgmtTypes.dart). Returns the entity data map (Partner).
