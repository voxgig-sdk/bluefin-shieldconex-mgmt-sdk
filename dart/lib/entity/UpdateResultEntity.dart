...
import 'dart:async';
import '../utility/ErrUtility.dart';import '../BluefinShieldconexMgmtEntityBase.dart';

// Typed models: see ../BluefinShieldconexMgmtTypes.dart (UpdateResult and the per-op request/match types).
class UpdateResultEntity extends BluefinShieldconexMgmtEntityBase {
  UpdateResultEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'update_result';
    name_ = 'update_result';
    Name = 'UpdateResult';
  }

  UpdateResultEntity make() {
    return UpdateResultEntity(client, entopts());
  }



  /// List UpdateResult entities by match (see UpdateResultListMatch in
  /// BluefinShieldconexMgmtTypes.dart). Returns a list of UpdateResult entity instances.
  ...
  /// Create a UpdateResult (see UpdateResultCreateData in
  /// BluefinShieldconexMgmtTypes.dart). Returns the entity data map (UpdateResult).
  ...
  /// Update a UpdateResult (see UpdateResultUpdateData in
  /// BluefinShieldconexMgmtTypes.dart). Returns the entity data map (UpdateResult).
