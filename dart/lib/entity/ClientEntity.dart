...
// Typed models: see ../BluefinShieldconexMgmtTypes.dart (Client and the per-op request/match types).
class ClientEntity extends BluefinShieldconexMgmtEntityBase {
  ClientEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'client';
    name_ = 'client';
    Name = 'Client';
  }
  ...
  ClientEntity make() {
    return ClientEntity(client, entopts());
  }


  /// Load a Client by match (see ClientLoadMatch in
  /// BluefinShieldconexMgmtTypes.dart). Returns the entity data map (Client).
  ...
  /// List Client entities by match (see ClientListMatch in
  /// BluefinShieldconexMgmtTypes.dart). Returns a list of Client entity instances.
  ...
  /// Create a Client (see ClientCreateData in
  /// BluefinShieldconexMgmtTypes.dart). Returns the entity data map (Client).
  ...
  /// Remove a Client by match (see ClientRemoveMatch in
  /// BluefinShieldconexMgmtTypes.dart). Returns the entity data map (Client).
