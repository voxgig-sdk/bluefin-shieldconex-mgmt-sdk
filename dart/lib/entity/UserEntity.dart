...
// Typed models: see ../BluefinShieldconexMgmtTypes.dart (User and the per-op request/match types).
class UserEntity extends BluefinShieldconexMgmtEntityBase {
  UserEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'user';
    name_ = 'user';
    Name = 'User';
  }
  ...
  UserEntity make() {
    return UserEntity(client, entopts());
  }


  /// Load a User by match (see UserLoadMatch in
  /// BluefinShieldconexMgmtTypes.dart). Returns the entity data map (User).
