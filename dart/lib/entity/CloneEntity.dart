...
// Typed models: see ../BluefinShieldconexMgmtTypes.dart (Clone and the per-op request/match types).
class CloneEntity extends BluefinShieldconexMgmtEntityBase {
  CloneEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'clone';
    name_ = 'clone';
    Name = 'Clone';
  }
  ...
  CloneEntity make() {
    return CloneEntity(client, entopts());
  }




  /// Create a Clone (see CloneCreateData in
  /// BluefinShieldconexMgmtTypes.dart). Returns the entity data map (Clone).
