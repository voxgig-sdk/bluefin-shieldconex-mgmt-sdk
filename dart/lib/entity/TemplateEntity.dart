...
// Typed models: see ../BluefinShieldconexMgmtTypes.dart (Template and the per-op request/match types).
class TemplateEntity extends BluefinShieldconexMgmtEntityBase {
  TemplateEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'template';
    name_ = 'template';
    Name = 'Template';
  }
  ...
  TemplateEntity make() {
    return TemplateEntity(client, entopts());
  }


  /// Load a Template by match (see TemplateLoadMatch in
  /// BluefinShieldconexMgmtTypes.dart). Returns the entity data map (Template).
  ...
  /// List Template entities by match (see TemplateListMatch in
  /// BluefinShieldconexMgmtTypes.dart). Returns a list of Template entity instances.
  ...
  /// Create a Template (see TemplateCreateData in
  /// BluefinShieldconexMgmtTypes.dart). Returns the entity data map (Template).
  ...
  /// Remove a Template by match (see TemplateRemoveMatch in
  /// BluefinShieldconexMgmtTypes.dart). Returns the entity data map (Template).
