...
// Typed models: see ../BluefinShieldconexMgmtTypes.dart (Transaction and the per-op request/match types).
class TransactionEntity extends BluefinShieldconexMgmtEntityBase {
  TransactionEntity(dynamic client, dynamic entopts) : super(client, entopts) {
    name = 'transaction';
    name_ = 'transaction';
    Name = 'Transaction';
  }
  ...
  TransactionEntity make() {
    return TransactionEntity(client, entopts());
  }


  /// Load a Transaction by match (see TransactionLoadMatch in
  /// BluefinShieldconexMgmtTypes.dart). Returns the entity data map (Transaction).
  ...
  /// List Transaction entities by match (see TransactionListMatch in
  /// BluefinShieldconexMgmtTypes.dart). Returns a list of Transaction entity instances.
