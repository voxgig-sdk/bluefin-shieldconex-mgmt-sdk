...
// data models are documented in BluefinShieldconexMgmtTypes.dart.
class BluefinShieldconexMgmtEntityBase {
  String name = '';
  String name_ = '';
  String Name = '';
  ...
  BluefinShieldconexMgmtEntityBase(dynamic client_, dynamic entopts_) {
