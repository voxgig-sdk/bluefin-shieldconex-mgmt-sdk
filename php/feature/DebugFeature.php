...
// BluefinShieldconexMgmt SDK debug feature
...
class BluefinShieldconexMgmtDebugFeature extends BluefinShieldconexMgmtBaseFeature
{
    ...
    private function _finish(BluefinShieldconexMgmtContext $ctx, bool $ok): void
    {
