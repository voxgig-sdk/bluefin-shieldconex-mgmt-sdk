...
class BluefinShieldconexMgmtProxyFeature extends BluefinShieldconexMgmtBaseFeature
{
    ...
    public function init(BluefinShieldconexMgmtContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (BluefinShieldconexMgmtContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
