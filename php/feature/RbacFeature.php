...
// BluefinShieldconexMgmt SDK rbac feature
...
class BluefinShieldconexMgmtRbacFeature extends BluefinShieldconexMgmtBaseFeature
{
    ...
    private function _required(BluefinShieldconexMgmtContext $ctx): ?string
    {
    ...
    private function _reject(BluefinShieldconexMgmtContext $ctx, string $required): void
    {
    ...
    private function _track(BluefinShieldconexMgmtContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
