...
class BluefinShieldconexMgmtFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; BluefinShieldconexMgmtSDK/1.0)';
    ...
    public static function call(BluefinShieldconexMgmtContext $ctx, string $fullurl, array $fetchdef): array
    {
