...
class UpdateResultEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new UpdateResultEntity($this->_client, $opts);
    }

    /**
     * @param UpdateResult|array $args UpdateResult data (assoc-array) to store.
     */
    ...
    /**
     * @return UpdateResult|array The current UpdateResult data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of UpdateResult fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of UpdateResult fields).
     */
    ...
    /**
     * List UpdateResult items matching the given filter.
     *
     * @param UpdateResultListMatch|array|null $reqmatch Match filter (any subset
     *   of UpdateResult fields) as an assoc-array; UpdateResultListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UpdateResult[]|array A list of UpdateResult items as assoc-arrays at
     ...
     *
     * @param UpdateResultCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed UpdateResultCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UpdateResult|array The created UpdateResult as an assoc-array at the
    ...
    /**
     * Update an existing UpdateResult.
     *
     * @param UpdateResultUpdateData|array|null $reqdata Body data as an assoc-array;
     *   a typed UpdateResultUpdateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return UpdateResult|array The updated UpdateResult as an assoc-array at the
     *   SDK boundary; throws BluefinShieldconexMgmtError on failure (item-5 convention).
     */
