...
class ClientEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ClientEntity($this->_client, $opts);
    }

    /**
     * @param Client|array $args Client data (assoc-array) to store.
     */
    ...
    /**
     * @return Client|array The current Client data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Client fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Client fields).
     */
     ...
     *
     * @param ClientLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed ClientLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Client|array The loaded Client as an assoc-array at the
     ...
     *
     * @param ClientListMatch|array|null $reqmatch Match filter (any subset
     *   of Client fields) as an assoc-array; ClientListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Client[]|array A list of Client items as assoc-arrays at
     ...
     * Create a new Client.
     *
     * @param ClientCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ClientCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Client|array The created Client as an assoc-array at the
     *   SDK boundary; throws BluefinShieldconexMgmtError on failure (item-5 convention).
     */
     ...
     *
     * @param ClientRemoveMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; ClientRemoveMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Client|array The removed Client as an assoc-array at the
     *   SDK boundary; throws BluefinShieldconexMgmtError on failure (item-5 convention).
     */
