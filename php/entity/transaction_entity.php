...
// BluefinShieldconexMgmt SDK Transaction entity
...
class TransactionEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TransactionEntity($this->_client, $opts);
    }

    /**
     * @param Transaction|array $args Transaction data (assoc-array) to store.
     */
    ...
    /**
     * @return Transaction|array The current Transaction data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Transaction fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Transaction fields).
     */
     ...
     *
     * @param TransactionLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed TransactionLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Transaction|array The loaded Transaction as an assoc-array at the
    ...
    /**
     * List Transaction items matching the given filter.
     *
     * @param TransactionListMatch|array|null $reqmatch Match filter (any subset
     *   of Transaction fields) as an assoc-array; TransactionListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Transaction[]|array A list of Transaction items as assoc-arrays at
