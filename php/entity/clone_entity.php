...
class CloneEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CloneEntity($this->_client, $opts);
    }

    /**
     * @param Clone|array $args Clone data (assoc-array) to store.
     */
    ...
    /**
     * @return Clone|array The current Clone data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Clone fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Clone fields).
     */
     ...
     * Create a new Clone.
     *
     * @param CloneCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed CloneCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Clone|array The created Clone as an assoc-array at the
