...
class PartnerEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PartnerEntity($this->_client, $opts);
    }

    /**
     * @param Partner|array $args Partner data (assoc-array) to store.
     */
    ...
    /**
     * @return Partner|array The current Partner data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Partner fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Partner fields).
     */
     ...
     *
     * @param PartnerLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed PartnerLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Partner|array The loaded Partner as an assoc-array at the
     ...
     *
     * @param PartnerListMatch|array|null $reqmatch Match filter (any subset
     *   of Partner fields) as an assoc-array; PartnerListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Partner[]|array A list of Partner items as assoc-arrays at
     ...
     *
     * @param PartnerCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed PartnerCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Partner|array The created Partner as an assoc-array at the
     *   SDK boundary; throws BluefinShieldconexMgmtError on failure (item-5 convention).
     */
