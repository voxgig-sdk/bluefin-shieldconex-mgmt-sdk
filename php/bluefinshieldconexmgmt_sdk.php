...
class BluefinShieldconexMgmtSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = BluefinShieldconexMgmtHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = BluefinShieldconexMgmtHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ($utility->feature_add)($this->_rootctx, BluefinShieldconexMgmtFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return BluefinShieldconexMgmtUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = BluefinShieldconexMgmtHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = BluefinShieldconexMgmtHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = BluefinShieldconexMgmtHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    public function direct(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = BluefinShieldconexMgmtHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function Client($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_client === null) {
                $this->_client = new ClientEntity($this, null);
            }
            return $this->_client;
        }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new BluefinShieldconexMgmtSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
