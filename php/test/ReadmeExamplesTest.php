...
// BluefinShieldconexMgmt SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (BluefinShieldconexMgmtSDK::test)
...
{
    private const SDK_CLASS = 'BluefinShieldconexMgmtSDK';
    ...
    private const SDK_BASE = 'bluefinshieldconexmgmt_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../bluefinshieldconexmgmt_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
