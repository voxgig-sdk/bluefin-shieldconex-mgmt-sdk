...
class UpdateResultDirectTest extends TestCase
{
    public function test_direct_list_update_result(): void
    {
        $setup = update_result_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-update_result", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
