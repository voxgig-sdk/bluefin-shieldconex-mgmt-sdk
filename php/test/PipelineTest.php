...
// BluefinShieldconexMgmt SDK pipeline test
//
...
{
    private static function utility(): BluefinShieldconexMgmtUtility
    {
        return new BluefinShieldconexMgmtUtility();
    }
    ...
    private static function ctx(array $over = []): BluefinShieldconexMgmtContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new BluefinShieldconexMgmtContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new BluefinShieldconexMgmtOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof BluefinShieldconexMgmtError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new BluefinShieldconexMgmtOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = BluefinShieldconexMgmtMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new BluefinShieldconexMgmtOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = BluefinShieldconexMgmtMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new BluefinShieldconexMgmtOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = BluefinShieldconexMgmtMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BluefinShieldconexMgmtSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = BluefinShieldconexMgmtMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new BluefinShieldconexMgmtResponse([]),
            'result' => new BluefinShieldconexMgmtResult([]),
        ]);
        [, $err] = BluefinShieldconexMgmtMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new BluefinShieldconexMgmtSpec([]),
            'response' => null,
            'result' => new BluefinShieldconexMgmtResult([]),
        ]);
        [, $err] = BluefinShieldconexMgmtMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new BluefinShieldconexMgmtSpec(['step' => 's']),
            'response' => new BluefinShieldconexMgmtResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new BluefinShieldconexMgmtResult([]),
        ]);
        [, $err] = BluefinShieldconexMgmtMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new BluefinShieldconexMgmtSpec(['step' => 's']),
            'response' => new BluefinShieldconexMgmtResponse(self::resp(200, ['v' => 1])),
            'result' => new BluefinShieldconexMgmtResult([]),
        ]);
        [, $err] = BluefinShieldconexMgmtMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new BluefinShieldconexMgmtSpec(['step' => 's']),
            'response' => new BluefinShieldconexMgmtResponse(self::resp(200, ['v' => 2])),
            'result' => new BluefinShieldconexMgmtResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        BluefinShieldconexMgmtMakeResponse::call($ctx);
    ...
    {
        $preset = new BluefinShieldconexMgmtResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new BluefinShieldconexMgmtSpec([]),
            'response' => new BluefinShieldconexMgmtResponse([]),
            'result' => new BluefinShieldconexMgmtResult([]),
        ...
        [$got, $err] = BluefinShieldconexMgmtMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new BluefinShieldconexMgmtResult([])]);
        [, $err] = BluefinShieldconexMgmtMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new BluefinShieldconexMgmtSpec([]), 'result' => null]);
        [, $err] = BluefinShieldconexMgmtMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BluefinShieldconexMgmtSpec(['step' => 's']),
            'result' => new BluefinShieldconexMgmtResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new BluefinShieldconexMgmtOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BluefinShieldconexMgmtMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new BluefinShieldconexMgmtSpec(['step' => 's']),
            'result' => new BluefinShieldconexMgmtResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new BluefinShieldconexMgmtOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = BluefinShieldconexMgmtMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new BluefinShieldconexMgmtResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new BluefinShieldconexMgmtSpec([]),
            'result' => new BluefinShieldconexMgmtResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = BluefinShieldconexMgmtMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BluefinShieldconexMgmtMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new BluefinShieldconexMgmtError('boom', 'boom');
        $utility->fetcher = function (BluefinShieldconexMgmtContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BluefinShieldconexMgmtSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = BluefinShieldconexMgmtMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (BluefinShieldconexMgmtContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = BluefinShieldconexMgmtMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(BluefinShieldconexMgmtResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        BluefinShieldconexMgmtMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (BluefinShieldconexMgmtContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new BluefinShieldconexMgmtSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = BluefinShieldconexMgmtMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new BluefinShieldconexMgmtResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new BluefinShieldconexMgmtSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = BluefinShieldconexMgmtMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = BluefinShieldconexMgmtMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = BluefinShieldconexMgmtMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new BluefinShieldconexMgmtResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, BluefinShieldconexMgmtDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new BluefinShieldconexMgmtResult(['ok' => false])]);
        $this->expectException(BluefinShieldconexMgmtError::class);
        BluefinShieldconexMgmtDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new BluefinShieldconexMgmtResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', BluefinShieldconexMgmtMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        BluefinShieldconexMgmtMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new BluefinShieldconexMgmtBaseFeature();
        $b = new BluefinShieldconexMgmtBaseFeature();
        BluefinShieldconexMgmtFeatureAdd::call($ctx, $a);
        BluefinShieldconexMgmtFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): BluefinShieldconexMgmtBaseFeature
    {
        $f = new BluefinShieldconexMgmtBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        BluefinShieldconexMgmtFeatureAdd::call($ctx, self::named_feature('a'));
        BluefinShieldconexMgmtFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        BluefinShieldconexMgmtFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        BluefinShieldconexMgmtFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        BluefinShieldconexMgmtFeatureAdd::call($ctx, $replace);
        ...
        BluefinShieldconexMgmtFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): BluefinShieldconexMgmtContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new BluefinShieldconexMgmtSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = BluefinShieldconexMgmtPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        BluefinShieldconexMgmtPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new BluefinShieldconexMgmtResponse(['headers' => null]),
            'result' => new BluefinShieldconexMgmtResult([]),
        ]);
        BluefinShieldconexMgmtResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        BluefinShieldconexMgmtResultBody::call($ctx);
