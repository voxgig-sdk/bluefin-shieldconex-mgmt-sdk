// UpdateResult entity client (generated — mirrors the rust Entity fragment).
...
typedef struct update_result_entity {
  ...
  Context* entctx;
} update_result_entity;

typedef void (*update_result_postdone_fn)(update_result_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT update_result_VT;
static const char* update_result_get_name(Entity* e);
static Entity* update_result_make(Entity* e);
static voxgig_value* update_result_data(Entity* e, voxgig_value* args);
static voxgig_value* update_result_matchv(Entity* e, voxgig_value* args);
static voxgig_value* update_result_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* update_result_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* update_result_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* update_result_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* update_result_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);

static Context* update_result_ent_ctx(update_result_entity* self) {
  return self->entctx;
}
...
Entity* update_result_entity_new(BluefinShieldconexMgmtSDK* client, voxgig_value* entopts) {
  ...
  update_result_entity* self = (update_result_entity*)calloc(1, sizeof(update_result_entity));
  self->base.vt = &update_result_VT;
  self->name = strdup("update_result");
  self->client = client;
...
static voxgig_value* update_result_run_op(update_result_entity* self, Context* ctx,
                                    update_result_postdone_fn post_done, PNError** err) {
...
voxgig_value* update_result_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  update_result_entity* self = (update_result_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, update_result_ent_ctx(self));
...
static const char* update_result_get_name(Entity* e) {
  return ((update_result_entity*)e)->name;
}
...
static Entity* update_result_make(Entity* e) {
  ...
  return update_result_entity_new(self->client, opts);
}
...
static voxgig_value* update_result_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(update_result_ent_ctx(self), "SetData");
  }
  feature_hook_util(update_result_ent_ctx(self), "GetData");
...
static voxgig_value* update_result_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(update_result_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(update_result_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}

static voxgig_value* update_result_load(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("load", "update_result");
  return NULL;
}


static void update_result_list_postdone(update_result_entity* self, Context* ctx) {
...
static voxgig_value* update_result_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, update_result_ent_ctx(self));
  return update_result_run_op(self, ctx, update_result_list_postdone, err);
}



static void update_result_create_postdone(update_result_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
...
static voxgig_value* update_result_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, update_result_ent_ctx(self));
  return update_result_run_op(self, ctx, update_result_create_postdone, err);
}



static void update_result_update_postdone(update_result_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resmatch = result->resmatch;
    voxgig_value* resdata = result->resdata;
...
static voxgig_value* update_result_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, update_result_ent_ctx(self));
  return update_result_run_op(self, ctx, update_result_update_postdone, err);
}


static voxgig_value* update_result_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "update_result");
  return NULL;
}

static const EntityVT update_result_VT = {
  update_result_get_name,
  update_result_make,
  update_result_data,
  update_result_matchv,
  update_result_load,
  update_result_list,
  update_result_create,
  update_result_update,
  update_result_remove,
};
