// Partner entity client (generated — mirrors the rust Entity fragment).
...
typedef void (*partner_postdone_fn)(partner_entity* self, Context* ctx);

// Forward declarations.
static const EntityVT partner_VT;
static const char* partner_get_name(Entity* e);
static Entity* partner_make(Entity* e);
static voxgig_value* partner_data(Entity* e, voxgig_value* args);
static voxgig_value* partner_matchv(Entity* e, voxgig_value* args);
static voxgig_value* partner_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* partner_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);
static voxgig_value* partner_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* partner_update(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err);
static voxgig_value* partner_remove(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err);

static Context* partner_ent_ctx(partner_entity* self) {
  return self->entctx;
}
...
Entity* partner_entity_new(BluefinShieldconexMgmtSDK* client, voxgig_value* entopts) {
  ...
  partner_entity* self = (partner_entity*)calloc(1, sizeof(partner_entity));
  self->base.vt = &partner_VT;
  self->name = strdup("partner");
  self->client = client;
...
static voxgig_value* partner_run_op(partner_entity* self, Context* ctx,
                                    partner_postdone_fn post_done, PNError** err) {
...
voxgig_value* partner_stream(Entity* e, const char* action, voxgig_value* args,
                             voxgig_value* callopts, PNError** err) {
  partner_entity* self = (partner_entity*)e;
  *err = NULL;
  ...
  Context* ctx = make_context_util(cs, partner_ent_ctx(self));
...
static Entity* partner_make(Entity* e) {
  ...
  return partner_entity_new(self->client, opts);
}
...
static voxgig_value* partner_data(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(partner_ent_ctx(self), "SetData");
  }
  feature_hook_util(partner_ent_ctx(self), "GetData");
...
static voxgig_value* partner_matchv(Entity* e, voxgig_value* args) {
  ...
  if (args && !v_is_noval(args) && !v_is_null(args)) {
    ...
    feature_hook_util(partner_ent_ctx(self), "SetMatch");
  }
  feature_hook_util(partner_ent_ctx(self), "GetMatch");
  return voxgig_clone(self->mtch);
}


static void partner_load_postdone(partner_entity* self, Context* ctx) {
...
static voxgig_value* partner_load(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, partner_ent_ctx(self));
  return partner_run_op(self, ctx, partner_load_postdone, err);
}



static void partner_list_postdone(partner_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resmatch = result->resmatch;
    if (voxgig_is_map(resmatch)) self->mtch = resmatch;
...
static voxgig_value* partner_list(Entity* e, voxgig_value* reqmatch, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqmatch = reqmatch;
  Context* ctx = make_context_util(cs, partner_ent_ctx(self));
  return partner_run_op(self, ctx, partner_list_postdone, err);
}



static void partner_create_postdone(partner_entity* self, Context* ctx) {
  SdkResult* result = ctx->result;
  if (result) {
    voxgig_value* resdata = result->resdata;
    if (!v_is_noval(resdata) && !v_is_null(resdata)) {
...
static voxgig_value* partner_create(Entity* e, voxgig_value* reqdata, voxgig_value* ctrl, PNError** err) {
  ...
  cs.reqdata = reqdata;
  Context* ctx = make_context_util(cs, partner_ent_ctx(self));
  return partner_run_op(self, ctx, partner_create_postdone, err);
}


static voxgig_value* partner_update(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("update", "partner");
  return NULL;
}

static voxgig_value* partner_remove(Entity* e, voxgig_value* reqarg, voxgig_value* ctrl, PNError** err) {
  (void)e; (void)reqarg; (void)ctrl;
  *err = unsupported_op("remove", "partner");
  return NULL;
}
