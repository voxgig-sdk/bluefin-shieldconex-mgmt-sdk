...
// ---- SDK client-base generic helpers (Main.fragment BluefinShieldconexMgmtSDK) -------
...
voxgig_value* sdk_options_map(BluefinShieldconexMgmtSDK* sdk) { return voxgig_clone(sdk->options); }

Utility* sdk_get_utility(BluefinShieldconexMgmtSDK* sdk) { return utility_copy(sdk->utility); }

Context* sdk_get_root_ctx(BluefinShieldconexMgmtSDK* sdk) { return sdk->rootctx; }
