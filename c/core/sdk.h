// BluefinShieldconexMgmt SDK — umbrella runtime header (template; BluefinShieldconexMgmt tokens
...
#ifndef BLUEFINSHIELDCONEXMGMT_SDK_H
#define BLUEFINSHIELDCONEXMGMT_SDK_H
...
typedef struct BluefinShieldconexMgmtSDK BluefinShieldconexMgmtSDK;
...
// ===========================================================================
// Error (mirrors core/error.rs BluefinShieldconexMgmtError)
// ===========================================================================

typedef struct PNError {
  char* sdk;   // "BluefinShieldconexMgmt"
...
// ===========================================================================
// Entity (vtable; mirrors core/types.rs Entity + BluefinShieldconexMgmtEntity)
// ===========================================================================
...
typedef struct EntityVT {
  ...
  // CRUD ops (BluefinShieldconexMgmtEntity). On error set *err.
...
// ===========================================================================
// SDK client (mirrors Main.fragment BluefinShieldconexMgmtSDK) — generic fields.
// ===========================================================================

struct BluefinShieldconexMgmtSDK {
  char* mode;             // "live" | "test"
  voxgig_value* options;
  Utility* utility;
...
void sdk_features_push(BluefinShieldconexMgmtSDK* sdk, Feature* f);
void sdk_features_insert(BluefinShieldconexMgmtSDK* sdk, size_t i, Feature* f);
void sdk_features_replace(BluefinShieldconexMgmtSDK* sdk, size_t i, Feature* f);

voxgig_value* sdk_options_map(BluefinShieldconexMgmtSDK* sdk); // deep clone of options
Utility* sdk_get_utility(BluefinShieldconexMgmtSDK* sdk);      // utility_copy
Context* sdk_get_root_ctx(BluefinShieldconexMgmtSDK* sdk);

// Constructors / prepare / direct are in the generated client.c:
BluefinShieldconexMgmtSDK* bluefinshieldconexmgmt_sdk_new(voxgig_value* options);
BluefinShieldconexMgmtSDK* test_sdk(voxgig_value* testopts, voxgig_value* sdkopts);
voxgig_value* sdk_prepare(BluefinShieldconexMgmtSDK* sdk, voxgig_value* fetchargs, PNError** err);
voxgig_value* sdk_direct(BluefinShieldconexMgmtSDK* sdk, voxgig_value* fetchargs, PNError** err);
...
#endif // BLUEFINSHIELDCONEXMGMT_SDK_H
