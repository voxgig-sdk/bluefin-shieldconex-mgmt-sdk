// Generated instance test for the template entity.
...
int main(void) {
  ...
  Entity* e = bluefin_shieldconex_mgmt_template(sdk, NULL);
  CHECK(e != NULL, "entity instance");
  CHECK_STR_EQ(e->vt->get_name(e), "template", "entity get_name");
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_shieldconex_mgmt_template(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = template_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_shieldconex_mgmt_template(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = template_stream(pe, "list", NULL, NULL, &perr);
