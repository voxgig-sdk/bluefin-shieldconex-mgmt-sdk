...
int main(void) {
  ...
  Entity* e = bluefinshieldconexmgmt_template(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefinshieldconexmgmt_template(strsdk, NULL);
    PNError* serr = NULL;
    ...
    Entity* pe = bluefinshieldconexmgmt_template(plainsdk, NULL);
    PNError* perr = NULL;
