...
int main(void) {
  ...
  Entity* e = bluefinshieldconexmgmt_partner(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefinshieldconexmgmt_partner(strsdk, NULL);
    PNError* serr = NULL;
    ...
    Entity* pe = bluefinshieldconexmgmt_partner(plainsdk, NULL);
    PNError* perr = NULL;
