// Generated instance test for the partner entity.
...
int main(void) {
  ...
  Entity* e = bluefin_shieldconex_mgmt_partner(sdk, NULL);
  CHECK(e != NULL, "entity instance");
  CHECK_STR_EQ(e->vt->get_name(e), "partner", "entity get_name");
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_shieldconex_mgmt_partner(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = partner_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_shieldconex_mgmt_partner(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = partner_stream(pe, "list", NULL, NULL, &perr);
