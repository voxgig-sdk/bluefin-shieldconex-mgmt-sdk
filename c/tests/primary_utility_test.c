...
static BluefinShieldconexMgmtSDK* C;
static Utility* U;
...
static void test_primary_fetcher_live(void) {
  ...
  BluefinShieldconexMgmtSDK* live = bluefinshieldconexmgmt_sdk_new(
...
static void test_primary_fetcher_blocked_test_mode(void) {
  BluefinShieldconexMgmtSDK* blocked = bluefinshieldconexmgmt_sdk_new(
...
static void test_primary_new_sdk_smoke(void) {
  BluefinShieldconexMgmtSDK* client = bluefinshieldconexmgmt_sdk_new(v_undef());
