// Minimal C test harness for the BluefinShieldconexMgmt SDK test binaries. Each test
...
#ifndef BLUEFINSHIELDCONEXMGMT_CTEST_H
#define BLUEFINSHIELDCONEXMGMT_CTEST_H
...
#endif // BLUEFINSHIELDCONEXMGMT_CTEST_H
