// Generated direct-call test for the update_result entity (mirrors the
...
static voxgig_value* update_result_mock(void* ud, voxgig_value* args) {
  CALLS++;
...
static BluefinShieldconexMgmtSDK* update_result_direct_setup(voxgig_value* mockres) {
...
int main(void) {
  ...
  // LIST
  {
    ...
    BluefinShieldconexMgmtSDK* sdk = update_result_direct_setup(mockres);
