...
int main(void) {
  ...
  Entity* e = bluefin_shieldconex_mgmt_clone(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_shieldconex_mgmt_clone(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = clone_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_shieldconex_mgmt_clone(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = clone_stream(pe, "list", NULL, NULL, &perr);
