...
int main(void) {
  ...
  BluefinShieldconexMgmtSDK* t = test_sdk(NULL, NULL);
  ...
  BluefinShieldconexMgmtSDK* sdk = bluefinshieldconexmgmt_sdk_new(opts);
  ...
  BluefinShieldconexMgmtSDK* rsdk = bluefinshieldconexmgmt_sdk_new(ropts);
  PNError* rerr = NULL;
