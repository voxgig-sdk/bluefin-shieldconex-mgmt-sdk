// Behavioural feature-test harness for the BluefinShieldconexMgmt SDK (C port of the
...
#ifndef BLUEFINSHIELDCONEXMGMT_FEATURE_HARNESS_H
#define BLUEFINSHIELDCONEXMGMT_FEATURE_HARNESS_H
...
#endif // BLUEFINSHIELDCONEXMGMT_FEATURE_HARNESS_H
