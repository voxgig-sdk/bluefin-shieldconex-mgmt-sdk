...
int main(void) {
  ...
  Entity* e = bluefin_shieldconex_mgmt_user(sdk, NULL);
  ...
  // the materialised items — either way every item is yielded.
  {
    ...
    Entity* se = bluefin_shieldconex_mgmt_user(strsdk, NULL);
    PNError* serr = NULL;
    voxgig_value* items = user_stream(se, "list", NULL, NULL, &serr);
    ...
    Entity* pe = bluefin_shieldconex_mgmt_user(plainsdk, NULL);
    PNError* perr = NULL;
    voxgig_value* pitems = user_stream(pe, "list", NULL, NULL, &perr);
