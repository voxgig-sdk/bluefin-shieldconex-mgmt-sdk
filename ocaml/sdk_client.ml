(* BluefinShieldconexMgmt SDK client (generated by @voxgig/sdkgen).
 *
...
(* Clone entity bound to a client:  clone client entopts *)
let clone (client : sdk_client) (entopts : value) : entity_obj =
  Sdk_entity_clone.make client entopts
...
(* Template entity bound to a client:  template client entopts *)
let template (client : sdk_client) (entopts : value) : entity_obj =
  Sdk_entity_template.make client entopts
