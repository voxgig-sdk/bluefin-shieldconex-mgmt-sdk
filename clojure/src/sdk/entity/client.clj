;; BluefinShieldconexMgmt SDK Client entity (generated by @voxgig/sdkgen).
(ns sdk.entity.client
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "client" :_client client :_utility utility :_entopts entopts
...
;; Canonical facade: (Client client data) accessor delegates here.
...
;; Load a single Client (reqmatch: id/query fields; nil = empty match).
...
;; List Client items matching a filter (reqmatch: any subset of fields).
...
;; Create a new Client (reqdata: body data).
...
;; Remove an Client matching the criteria (reqmatch: id/query fields).
