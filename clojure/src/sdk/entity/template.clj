;; BluefinShieldconexMgmt SDK Template entity (generated by @voxgig/sdkgen).
(ns sdk.entity.template
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "template" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "template")
...
;; Canonical facade: (Template client data) accessor delegates here.
...
;; Load a single Template (reqmatch: id/query fields; nil = empty match).
...
;; List Template items matching a filter (reqmatch: any subset of fields).
...
;; Create a new Template (reqdata: body data).
...
;; Remove an Template matching the criteria (reqmatch: id/query fields).
