;; BluefinShieldconexMgmt SDK Partner entity (generated by @voxgig/sdkgen).
(ns sdk.entity.partner
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "partner" :_client client :_utility utility :_entopts entopts
...
;; Canonical facade: (Partner client data) accessor delegates here.
...
;; Load a single Partner (reqmatch: id/query fields; nil = empty match).
...
;; List Partner items matching a filter (reqmatch: any subset of fields).
...
;; Create a new Partner (reqdata: body data).
