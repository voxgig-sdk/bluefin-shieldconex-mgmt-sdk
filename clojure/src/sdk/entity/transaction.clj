;; BluefinShieldconexMgmt SDK Transaction entity (generated by @voxgig/sdkgen).
(ns sdk.entity.transaction
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "transaction" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "transaction")
...
;; Canonical facade: (Transaction client data) accessor delegates here.
...
;; Load a single Transaction (reqmatch: id/query fields; nil = empty match).
...
;; List Transaction items matching a filter (reqmatch: any subset of fields).
