;; BluefinShieldconexMgmt SDK User entity (generated by @voxgig/sdkgen).
(ns sdk.entity.user
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "user" :_client client :_utility utility :_entopts entopts
...
;; Canonical facade: (User client data) accessor delegates here.
...
;; Load a single User (reqmatch: id/query fields; nil = empty match).
