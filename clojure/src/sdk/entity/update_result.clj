;; BluefinShieldconexMgmt SDK UpdateResult entity (generated by @voxgig/sdkgen).
(ns sdk.entity.update_result
...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "update_result" :_client client :_utility utility :_entopts entopts
             :_data data :_match match :_entctx entctx
             :get-name (fn [] "update_result")
...
;; Canonical facade: (UpdateResult client data) accessor delegates here.
...
;; List UpdateResult items matching a filter (reqmatch: any subset of fields).
...
;; Create a new UpdateResult (reqdata: body data).
...
;; Update an existing UpdateResult (reqdata: body data).
