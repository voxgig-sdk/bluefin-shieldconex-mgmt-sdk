...
(defn- new-entity [client entopts]
  (let [entopts (ensure-entopts entopts)
        ...
        ent {:_name "clone" :_client client :_utility utility :_entopts entopts
...
;; Canonical facade: (Clone client data) accessor delegates here.
...
;; Create a new Clone (reqdata: body data).
