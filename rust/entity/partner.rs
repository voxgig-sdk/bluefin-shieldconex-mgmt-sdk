// Partner entity client (generated — mirrors the go Entity fragment).
...
impl PartnerEntity {
    pub fn new(client: &Rc<BluefinShieldconexMgmtSDK>, entopts: Value) -> Rc<PartnerEntity> {
...
impl Entity for PartnerEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        PartnerEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinShieldconexMgmtEntity for PartnerEntity {
