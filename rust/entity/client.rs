// Client entity client (generated — mirrors the go Entity fragment).
...
impl ClientEntity {
    pub fn new(client: &Rc<BluefinShieldconexMgmtSDK>, entopts: Value) -> Rc<ClientEntity> {
...
impl Entity for ClientEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        ClientEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinShieldconexMgmtEntity for ClientEntity {
