// UpdateResult entity client (generated — mirrors the go Entity fragment).
...
impl UpdateResultEntity {
    pub fn new(client: &Rc<BluefinShieldconexMgmtSDK>, entopts: Value) -> Rc<UpdateResultEntity> {
        ...
        let e = Rc::new(UpdateResultEntity {
...
impl Entity for UpdateResultEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        UpdateResultEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
