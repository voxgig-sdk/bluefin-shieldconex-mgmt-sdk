// Transaction entity client (generated — mirrors the go Entity fragment).
...
impl TransactionEntity {
    pub fn new(client: &Rc<BluefinShieldconexMgmtSDK>, entopts: Value) -> Rc<TransactionEntity> {
        ...
        let e = Rc::new(TransactionEntity {
...
impl Entity for TransactionEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        TransactionEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinShieldconexMgmtEntity for TransactionEntity {
