// Template entity client (generated — mirrors the go Entity fragment).
...
impl TemplateEntity {
    pub fn new(client: &Rc<BluefinShieldconexMgmtSDK>, entopts: Value) -> Rc<TemplateEntity> {
...
impl Entity for TemplateEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        TemplateEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinShieldconexMgmtEntity for TemplateEntity {
    ...
    fn remove(&self, reqmatch: Value, ctrl: Value) -> Result<Value, BluefinShieldconexMgmtError> {
        let ctx = self.utility.make_context(
            CtxSpec {
