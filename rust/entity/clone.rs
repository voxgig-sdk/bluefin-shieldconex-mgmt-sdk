// Clone entity client (generated — mirrors the go Entity fragment).
...
impl CloneEntity {
    pub fn new(client: &Rc<BluefinShieldconexMgmtSDK>, entopts: Value) -> Rc<CloneEntity> {
...
impl Entity for CloneEntity {
    ...
    fn make(&self) -> Rc<dyn Entity> {
        ...
        CloneEntity::new(&self.client, opts) as Rc<dyn Entity>
    }
...
impl BluefinShieldconexMgmtEntity for CloneEntity {
