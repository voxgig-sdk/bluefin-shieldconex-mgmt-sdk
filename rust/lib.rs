// BluefinShieldconexMgmt SDK for Rust (generated by @voxgig/sdkgen).
//
...
pub use crate::core::error::BluefinShieldconexMgmtError;
...
pub use crate::core::sdk::{test_sdk, BluefinShieldconexMgmtSDK};
pub use crate::core::spec::Spec;
pub use crate::core::types::{
    Entity, Feature, FeatureRef, FetcherFn, OutVal, BluefinShieldconexMgmtEntity,
};
...
// No-argument convenience constructors: `bluefin_shieldconex_mgmt_sdk::new()` /
// `bluefin_shieldconex_mgmt_sdk::test()` for the common no-options case.
use std::rc::Rc;

pub fn new() -> Rc<BluefinShieldconexMgmtSDK> {
    BluefinShieldconexMgmtSDK::new(Value::Noval)
}

pub fn test() -> Rc<BluefinShieldconexMgmtSDK> {
