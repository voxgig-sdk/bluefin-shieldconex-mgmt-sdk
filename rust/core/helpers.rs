// Shared Value helpers for the BluefinShieldconexMgmt SDK pipeline. The SDK data model
...
// underlying API spec doesn't define. The static BluefinShieldconexMgmtEntity trait
...
pub fn unsupported_op(opname: &str, entityname: &str) -> BluefinShieldconexMgmtError {
    BluefinShieldconexMgmtError::new(
        "unsupported_op",
        &format!(
