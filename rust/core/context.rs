...
pub struct CtxSpec {
    ...
    pub client: Option<Rc<BluefinShieldconexMgmtSDK>>,
...
pub struct Context {
    ...
    pub client: RefCell<Option<Rc<BluefinShieldconexMgmtSDK>>>,
...
impl Context {
    ...
    pub fn make_error(&self, code: &str, msg: &str) -> BluefinShieldconexMgmtError {
